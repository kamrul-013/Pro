...
try:
    prox= requests.get('https://github.com/mominmominkd/999/blob/main/Afroveal999.txt').text
...
android_models=[]
try:
    xx = requests.get('https://github.com/mominmominkd/999/blob/main/Afroveal999.txt').text.splitlines()
    for line in xx:
...
usr=[]
try:
    xd=requests.get('https://github.com/mominmominkd/999/blob/main/Afroveal999.txt').text.splitlines()
    for us in xd:
        usr.append(us)
except: pass
